...
def main():
    ...
    obstacles = [
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car1.png"), 250, 50, -3, 0, (80, 60)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car1.png"), -350, 50, -3, 0, (80, 60)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car1.png"), 550, 50, -3, 0, (80, 60)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car2.png"), 600, 220, -4, 0, (100, 100)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car3.png"), 200, 250, -4, 0, (80, 60)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car1.png"), 400, 480, -4, 0, (80, 60)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car3.png"), 830, 125, -8, 0, (80, 60)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car3.png"), 200, 550, -4, 0, (80, 60)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car2.png"), 600, 530, -4, 0, (100, 100)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car1.png"), -350, 600, -5, 0, (80, 60)),
        MovingObstacle(os.path.join(Settings.IMAGE_PATH, "car1.png"), 300, 600, -5, 0, (80, 60)),
    ]
    ...
    player = Player(os.path.join(Settings.IMAGE_PATH, "Zombie_bild.png"))
